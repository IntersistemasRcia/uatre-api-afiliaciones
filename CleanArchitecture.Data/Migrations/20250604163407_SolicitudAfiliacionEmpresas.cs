        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total_Trabajadores = table.Column<long>(type: "bigint", nullable: false),
                    Total_Trab_Rurales = table.Column<int>(type: "int", nullable: false),
                    Total_Trab_NoRurales = table.Column<int>(type: "int", nullable: false),
                    Total_Trab_Rurales_Afiliados = table.Column<int>(type: "int", nullable: false),
                    Total_Trab_Rurales_NoAfiliados = table.Column<int>(type: "int", nullable: false),
                    Total_Trab_NoRurales_Afiliados = table.Column<int>(type: "int", nullable: false),
                    Total_Trab_NoRurales_NoAfiliados = table.Column<int>(type: "int", nullable: false),
                    Guid = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
