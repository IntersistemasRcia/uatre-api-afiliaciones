...
public class DdjjRepository : IDdjjRepository
{
    ...
    {
        return await db.QueryFirstOrDefaultAsync<DdjjUatre>("SELECT TOP 1 Periodo, CondicionRural FROM DDJJUatre WHERE CUIL = @Cuil ORDER BY Periodo DESC", new { Cuil = cuil });
    }
}
