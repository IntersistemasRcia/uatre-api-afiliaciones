...
{
    private readonly ILogger<CreateSeccionalContactoCommandHandler> logger;
    private readonly IMapper mapper;
    private readonly IUnitOfWork unitOfWork;

    public CreateSeccionalContactoCommandHandler(ILogger<CreateSeccionalContactoCommandHandler> logger, IMapper mapper, IUnitOfWork unitOfWork)
    {
        this.logger = logger;
        this.mapper = mapper;
