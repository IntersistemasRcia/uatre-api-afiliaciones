...
namespace CleanArchitecture.Infrastructure.Repositories
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        {
            // Usar la API de EF para comenzar una transacción; si se necesita control de aislamiento
            // lo gestionaremos en una siguiente iteración con soporte explícito según proveedor.
